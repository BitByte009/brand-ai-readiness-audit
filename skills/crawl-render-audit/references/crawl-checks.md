...
## Current utility and archive scope

Utility routes are recognized at any path depth, including common HTML/PHP/ASP
extensions. D-CRAWL-01 excludes links explicitly labelled EOL/end-of-life or an
unsupported/retired version: their deliberate crawl exclusion is not automatically
a defect. The collector still respects robots and records the skipped scope.
